...
// The InterviewFavoriteFunc type is an adapter to allow the use of ordinary
// function as InterviewFavorite mutator.
type InterviewFavoriteFunc func(context.Context, *ent.InterviewFavoriteMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InterviewFavoriteFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InterviewFavoriteMutation); ok {
		return f(ctx, mv)
	}
